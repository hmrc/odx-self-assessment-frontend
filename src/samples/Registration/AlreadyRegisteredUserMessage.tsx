...
const AlreadyRegisteredUserMessage = () => {
  ...
  return (
    <MainWrapper showPageNotWorkingLink={false}>
      <h1 className='govuk-heading-l'>{t('YOU_HAVE_PREVIOUSLY_REGISTERED_FOR_SELF_ASSESSMENT')}</h1>
      <div className='govuk-body'>
        ...
        <p className='govuk-body'>{t('YOUR_GOVERNMENT_GATEWAY_USER_ID_AND_PASSWORD_TO_SIGN_IN')}</p>
