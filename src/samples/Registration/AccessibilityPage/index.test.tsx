...
describe('should render component Accessibility for registration.', () => {
  let t;
  afterEach(cleanup);
  ...
  it('should render Accessibility for registration content in English.', async () => {
    let asFragment;
  ...
  it('should render Accessibility for registration content in Welsh.', async () => {
    let asFragment;
